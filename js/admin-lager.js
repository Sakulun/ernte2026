...
import { getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml, sorteBadge } from './helpers.js?v=60';
import { getFruchtFarbe } from './frucht.js?v=60';
import { getSiloBioStatus, bioBadge } from './bio.js?v=60';
import { feuchteZuHoch } from './quality.js?v=60';
import { lagerGruppen, getSiloAusgang, fuhreHerkunft } from './silo.js?v=60';
