...
import { getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml, sorteBadge } from './helpers.js?v=61';
import { getFruchtFarbe } from './frucht.js?v=61';
import { getSiloBioStatus, bioBadge } from './bio.js?v=61';
import { feuchteZuHoch } from './quality.js?v=61';
import { lagerGruppen, getSiloAusgang, fuhreHerkunft } from './silo.js?v=61';
