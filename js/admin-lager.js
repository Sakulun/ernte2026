...
import { getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml, sorteBadge } from './helpers.js?v=44';
import { getFruchtFarbe } from './frucht.js?v=44';
import { getSiloBioStatus, bioBadge } from './bio.js?v=44';
import { feuchteZuHoch } from './quality.js?v=44';
import { lagerGruppen, getSiloAusgang, fuhreHerkunft } from './silo.js?v=44';
