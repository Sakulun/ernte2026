...
import { getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml, sorteBadge } from './helpers.js?v=130';
import { getFruchtFarbe } from './frucht.js?v=130';
import { getSiloBioStatus, bioBadge } from './bio.js?v=130';
import { feuchteZuHoch } from './quality.js?v=130';
import { lagerGruppen, getSiloAusgang, fuhreHerkunft } from './silo.js?v=130';
