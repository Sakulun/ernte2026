...
import { getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml, sorteBadge } from './helpers.js?v=128';
import { getFruchtFarbe } from './frucht.js?v=128';
import { getSiloBioStatus, bioBadge } from './bio.js?v=128';
import { feuchteZuHoch } from './quality.js?v=128';
import { lagerGruppen, getSiloAusgang, fuhreHerkunft } from './silo.js?v=128';
