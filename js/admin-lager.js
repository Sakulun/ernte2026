...
import { getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml, sorteBadge } from './helpers.js?v=84';
import { getFruchtFarbe } from './frucht.js?v=84';
import { getSiloBioStatus, bioBadge } from './bio.js?v=84';
import { feuchteZuHoch } from './quality.js?v=84';
import { lagerGruppen, getSiloAusgang, fuhreHerkunft } from './silo.js?v=84';
