...
import { getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml, sorteBadge } from './helpers.js?v=72';
import { getFruchtFarbe } from './frucht.js?v=72';
import { getSiloBioStatus, bioBadge } from './bio.js?v=72';
import { feuchteZuHoch } from './quality.js?v=72';
import { lagerGruppen, getSiloAusgang, fuhreHerkunft } from './silo.js?v=72';
