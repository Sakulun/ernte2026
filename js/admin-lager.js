...
import { getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml, sorteBadge } from './helpers.js?v=127';
import { getFruchtFarbe } from './frucht.js?v=127';
import { getSiloBioStatus, bioBadge } from './bio.js?v=127';
import { feuchteZuHoch } from './quality.js?v=127';
import { lagerGruppen, getSiloAusgang, fuhreHerkunft } from './silo.js?v=127';
