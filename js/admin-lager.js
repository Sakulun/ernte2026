...
import { getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml, sorteBadge } from './helpers.js?v=83';
import { getFruchtFarbe } from './frucht.js?v=83';
import { getSiloBioStatus, bioBadge } from './bio.js?v=83';
import { feuchteZuHoch } from './quality.js?v=83';
import { lagerGruppen, getSiloAusgang, fuhreHerkunft } from './silo.js?v=83';
