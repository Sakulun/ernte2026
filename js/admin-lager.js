...
import { getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml, sorteBadge } from './helpers.js?v=115';
import { getFruchtFarbe } from './frucht.js?v=115';
import { getSiloBioStatus, bioBadge } from './bio.js?v=115';
import { feuchteZuHoch } from './quality.js?v=115';
import { lagerGruppen, getSiloAusgang, fuhreHerkunft } from './silo.js?v=115';
