...
import { getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml, sorteBadge } from './helpers.js?v=90';
import { getFruchtFarbe } from './frucht.js?v=90';
import { getSiloBioStatus, bioBadge } from './bio.js?v=90';
import { feuchteZuHoch } from './quality.js?v=90';
import { lagerGruppen, getSiloAusgang, fuhreHerkunft } from './silo.js?v=90';
