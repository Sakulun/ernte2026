...
import { getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml, sorteBadge } from './helpers.js?v=62';
import { getFruchtFarbe } from './frucht.js?v=62';
import { getSiloBioStatus, bioBadge } from './bio.js?v=62';
import { feuchteZuHoch } from './quality.js?v=62';
import { lagerGruppen, getSiloAusgang, fuhreHerkunft } from './silo.js?v=62';
