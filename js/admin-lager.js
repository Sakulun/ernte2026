...
import { getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml, sorteBadge } from './helpers.js?v=51';
import { getFruchtFarbe } from './frucht.js?v=51';
import { getSiloBioStatus, bioBadge } from './bio.js?v=51';
import { feuchteZuHoch } from './quality.js?v=51';
import { lagerGruppen, getSiloAusgang, fuhreHerkunft } from './silo.js?v=51';
