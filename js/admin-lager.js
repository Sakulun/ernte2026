...
import { getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml, sorteBadge } from './helpers.js?v=136';
import { getFruchtFarbe } from './frucht.js?v=136';
import { getSiloBioStatus, bioBadge } from './bio.js?v=136';
import { feuchteZuHoch } from './quality.js?v=136';
import { lagerGruppen, getSiloAusgang, fuhreHerkunft } from './silo.js?v=136';
