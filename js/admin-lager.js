...
import { getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml, sorteBadge } from './helpers.js?v=111';
import { getFruchtFarbe } from './frucht.js?v=111';
import { getSiloBioStatus, bioBadge } from './bio.js?v=111';
import { feuchteZuHoch } from './quality.js?v=111';
import { lagerGruppen, getSiloAusgang, fuhreHerkunft } from './silo.js?v=111';
