...
import { getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml, sorteBadge } from './helpers.js?v=63';
import { getFruchtFarbe } from './frucht.js?v=63';
import { getSiloBioStatus, bioBadge } from './bio.js?v=63';
import { feuchteZuHoch } from './quality.js?v=63';
import { lagerGruppen, getSiloAusgang, fuhreHerkunft } from './silo.js?v=63';
