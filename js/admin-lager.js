...
import { getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml, sorteBadge } from './helpers.js?v=103';
import { getFruchtFarbe } from './frucht.js?v=103';
import { getSiloBioStatus, bioBadge } from './bio.js?v=103';
import { feuchteZuHoch } from './quality.js?v=103';
import { lagerGruppen, getSiloAusgang, fuhreHerkunft } from './silo.js?v=103';
