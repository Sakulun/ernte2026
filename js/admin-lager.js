...
import { getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml, sorteBadge } from './helpers.js?v=104';
import { getFruchtFarbe } from './frucht.js?v=104';
import { getSiloBioStatus, bioBadge } from './bio.js?v=104';
import { feuchteZuHoch } from './quality.js?v=104';
import { lagerGruppen, getSiloAusgang, fuhreHerkunft } from './silo.js?v=104';
