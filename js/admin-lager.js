...
import { getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml, sorteBadge } from './helpers.js?v=110';
import { getFruchtFarbe } from './frucht.js?v=110';
import { getSiloBioStatus, bioBadge } from './bio.js?v=110';
import { feuchteZuHoch } from './quality.js?v=110';
import { lagerGruppen, getSiloAusgang, fuhreHerkunft } from './silo.js?v=110';
