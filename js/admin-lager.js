...
import { getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml, sorteBadge } from './helpers.js?v=135';
import { getFruchtFarbe } from './frucht.js?v=135';
import { getSiloBioStatus, bioBadge } from './bio.js?v=135';
import { feuchteZuHoch } from './quality.js?v=135';
import { lagerGruppen, getSiloAusgang, fuhreHerkunft } from './silo.js?v=135';
