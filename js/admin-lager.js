...
import { getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml, sorteBadge } from './helpers.js?v=52';
import { getFruchtFarbe } from './frucht.js?v=52';
import { getSiloBioStatus, bioBadge } from './bio.js?v=52';
import { feuchteZuHoch } from './quality.js?v=52';
import { lagerGruppen, getSiloAusgang, fuhreHerkunft } from './silo.js?v=52';
