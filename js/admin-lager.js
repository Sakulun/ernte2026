...
import { getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml, sorteBadge } from './helpers.js?v=89';
import { getFruchtFarbe } from './frucht.js?v=89';
import { getSiloBioStatus, bioBadge } from './bio.js?v=89';
import { feuchteZuHoch } from './quality.js?v=89';
import { lagerGruppen, getSiloAusgang, fuhreHerkunft } from './silo.js?v=89';
