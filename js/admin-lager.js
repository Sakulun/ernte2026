...
import { getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml, sorteBadge } from './helpers.js?v=75';
import { getFruchtFarbe } from './frucht.js?v=75';
import { getSiloBioStatus, bioBadge } from './bio.js?v=75';
import { feuchteZuHoch } from './quality.js?v=75';
import { lagerGruppen, getSiloAusgang, fuhreHerkunft } from './silo.js?v=75';
