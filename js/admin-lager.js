...
import { getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml, sorteBadge } from './helpers.js?v=121';
import { getFruchtFarbe } from './frucht.js?v=121';
import { getSiloBioStatus, bioBadge } from './bio.js?v=121';
import { feuchteZuHoch } from './quality.js?v=121';
import { lagerGruppen, getSiloAusgang, fuhreHerkunft } from './silo.js?v=121';
