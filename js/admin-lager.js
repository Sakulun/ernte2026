...
import { getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml, sorteBadge } from './helpers.js?v=85';
import { getFruchtFarbe } from './frucht.js?v=85';
import { getSiloBioStatus, bioBadge } from './bio.js?v=85';
import { feuchteZuHoch } from './quality.js?v=85';
import { lagerGruppen, getSiloAusgang, fuhreHerkunft } from './silo.js?v=85';
