...
import { getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml, sorteBadge } from './helpers.js?v=82';
import { getFruchtFarbe } from './frucht.js?v=82';
import { getSiloBioStatus, bioBadge } from './bio.js?v=82';
import { feuchteZuHoch } from './quality.js?v=82';
import { lagerGruppen, getSiloAusgang, fuhreHerkunft } from './silo.js?v=82';
