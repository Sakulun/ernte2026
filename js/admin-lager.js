...
import { getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml, sorteBadge } from './helpers.js?v=109';
import { getFruchtFarbe } from './frucht.js?v=109';
import { getSiloBioStatus, bioBadge } from './bio.js?v=109';
import { feuchteZuHoch } from './quality.js?v=109';
import { lagerGruppen, getSiloAusgang, fuhreHerkunft } from './silo.js?v=109';
