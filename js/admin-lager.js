...
import { getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml, sorteBadge } from './helpers.js?v=139';
import { getFruchtFarbe } from './frucht.js?v=139';
import { getSiloBioStatus, bioBadge } from './bio.js?v=139';
import { feuchteZuHoch } from './quality.js?v=139';
import { lagerGruppen, getSiloAusgang, fuhreHerkunft } from './silo.js?v=139';
