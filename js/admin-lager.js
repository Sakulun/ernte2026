...
import { getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml, sorteBadge } from './helpers.js?v=129';
import { getFruchtFarbe } from './frucht.js?v=129';
import { getSiloBioStatus, bioBadge } from './bio.js?v=129';
import { feuchteZuHoch } from './quality.js?v=129';
import { lagerGruppen, getSiloAusgang, fuhreHerkunft } from './silo.js?v=129';
