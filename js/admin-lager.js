...
import { getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml, sorteBadge } from './helpers.js?v=142';
import { getFruchtFarbe } from './frucht.js?v=142';
import { getSiloBioStatus, bioBadge } from './bio.js?v=142';
import { feuchteZuHoch } from './quality.js?v=142';
import { lagerGruppen, getSiloAusgang, fuhreHerkunft } from './silo.js?v=142';
