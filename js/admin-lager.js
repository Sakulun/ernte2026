...
import { getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml, sorteBadge } from './helpers.js?v=49';
import { getFruchtFarbe } from './frucht.js?v=49';
import { getSiloBioStatus, bioBadge } from './bio.js?v=49';
import { feuchteZuHoch } from './quality.js?v=49';
import { lagerGruppen, getSiloAusgang, fuhreHerkunft } from './silo.js?v=49';
