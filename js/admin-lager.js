...
import { getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml, sorteBadge } from './helpers.js?v=112';
import { getFruchtFarbe } from './frucht.js?v=112';
import { getSiloBioStatus, bioBadge } from './bio.js?v=112';
import { feuchteZuHoch } from './quality.js?v=112';
import { lagerGruppen, getSiloAusgang, fuhreHerkunft } from './silo.js?v=112';
