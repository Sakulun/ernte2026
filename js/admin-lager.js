...
import { getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml, sorteBadge } from './helpers.js?v=116';
import { getFruchtFarbe } from './frucht.js?v=116';
import { getSiloBioStatus, bioBadge } from './bio.js?v=116';
import { feuchteZuHoch } from './quality.js?v=116';
import { lagerGruppen, getSiloAusgang, fuhreHerkunft } from './silo.js?v=116';
