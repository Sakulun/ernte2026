...
import { getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml, sorteBadge } from './helpers.js?v=119';
import { getFruchtFarbe } from './frucht.js?v=119';
import { getSiloBioStatus, bioBadge } from './bio.js?v=119';
import { feuchteZuHoch } from './quality.js?v=119';
import { lagerGruppen, getSiloAusgang, fuhreHerkunft } from './silo.js?v=119';
