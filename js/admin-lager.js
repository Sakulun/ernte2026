...
import { getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml, sorteBadge } from './helpers.js?v=120';
import { getFruchtFarbe } from './frucht.js?v=120';
import { getSiloBioStatus, bioBadge } from './bio.js?v=120';
import { feuchteZuHoch } from './quality.js?v=120';
import { lagerGruppen, getSiloAusgang, fuhreHerkunft } from './silo.js?v=120';
