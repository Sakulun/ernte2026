...
import { getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml, sorteBadge } from './helpers.js?v=76';
import { getFruchtFarbe } from './frucht.js?v=76';
import { getSiloBioStatus, bioBadge } from './bio.js?v=76';
import { feuchteZuHoch } from './quality.js?v=76';
import { lagerGruppen, getSiloAusgang, fuhreHerkunft } from './silo.js?v=76';
