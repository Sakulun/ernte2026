...
import { getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml, sorteBadge } from './helpers.js?v=86';
import { getFruchtFarbe } from './frucht.js?v=86';
import { getSiloBioStatus, bioBadge } from './bio.js?v=86';
import { feuchteZuHoch } from './quality.js?v=86';
import { lagerGruppen, getSiloAusgang, fuhreHerkunft } from './silo.js?v=86';
