...
import { getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml, sorteBadge } from './helpers.js?v=124';
import { getFruchtFarbe } from './frucht.js?v=124';
import { getSiloBioStatus, bioBadge } from './bio.js?v=124';
import { feuchteZuHoch } from './quality.js?v=124';
import { lagerGruppen, getSiloAusgang, fuhreHerkunft } from './silo.js?v=124';
