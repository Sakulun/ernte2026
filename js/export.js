...
import { getFeld, getUser, netto, showToast, istErnteFuhre, fuhrenArt } from './helpers.js?v=138';
import { getSiloFill, getSiloKultur } from './silo.js?v=138';
import { mengenUebersichtDaten } from './admin-vermehrungen.js?v=138';
import {
