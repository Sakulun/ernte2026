...
import { getFeld, getUser, netto, showToast, istErnteFuhre, fuhrenArt } from './helpers.js?v=130';
import { getSiloFill, getSiloKultur } from './silo.js?v=130';
import { mengenUebersichtDaten } from './admin-vermehrungen.js?v=130';
import {
