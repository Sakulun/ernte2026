...
import { getFeld, getUser, netto, showToast, istErnteFuhre, fuhrenArt } from './helpers.js?v=143';
import { getSiloFill, getSiloKultur } from './silo.js?v=143';
import { mengenUebersichtDaten } from './admin-vermehrungen.js?v=143';
import {
