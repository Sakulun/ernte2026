...
import { getFeld, getUser, netto, showToast, istErnteFuhre, fuhrenArt } from './helpers.js?v=112';
import { getSiloFill, getSiloKultur } from './silo.js?v=112';
import { mengenUebersichtDaten } from './admin-vermehrungen.js?v=112';
import {
