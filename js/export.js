...
import { getFeld, getUser, netto, showToast, istErnteFuhre, fuhrenArt } from './helpers.js?v=124';
import { getSiloFill, getSiloKultur } from './silo.js?v=124';
import { mengenUebersichtDaten } from './admin-vermehrungen.js?v=124';
import {
