...
import { getFeld, getUser, netto, showToast, istErnteFuhre, fuhrenArt } from './helpers.js?v=121';
import { getSiloFill, getSiloKultur } from './silo.js?v=121';
import { mengenUebersichtDaten } from './admin-vermehrungen.js?v=121';
import {
