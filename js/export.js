...
import { getFeld, getUser, netto, showToast, istErnteFuhre, fuhrenArt } from './helpers.js?v=118';
import { getSiloFill, getSiloKultur } from './silo.js?v=118';
import { mengenUebersichtDaten } from './admin-vermehrungen.js?v=118';
import {
