...
import { getFeld, getUser, netto, showToast, istErnteFuhre, fuhrenArt } from './helpers.js?v=134';
import { getSiloFill, getSiloKultur } from './silo.js?v=134';
import { mengenUebersichtDaten } from './admin-vermehrungen.js?v=134';
import {
