...
import { getFeld, getUser, netto, showToast, istErnteFuhre, fuhrenArt } from './helpers.js?v=129';
import { getSiloFill, getSiloKultur } from './silo.js?v=129';
import { mengenUebersichtDaten } from './admin-vermehrungen.js?v=129';
import {
