...
import { getFeld, getUser, netto, showToast, istErnteFuhre, fuhrenArt } from './helpers.js?v=113';
import { getSiloFill, getSiloKultur } from './silo.js?v=113';
import { mengenUebersichtDaten } from './admin-vermehrungen.js?v=113';
import {
