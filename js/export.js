...
import { getFeld, getUser, netto, showToast, istErnteFuhre, fuhrenArt } from './helpers.js?v=120';
import { getSiloFill, getSiloKultur } from './silo.js?v=120';
import { mengenUebersichtDaten } from './admin-vermehrungen.js?v=120';
import {
