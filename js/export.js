...
import { getFeld, getUser, netto, showToast, istErnteFuhre, fuhrenArt } from './helpers.js?v=116';
import { getSiloFill, getSiloKultur } from './silo.js?v=116';
import { mengenUebersichtDaten } from './admin-vermehrungen.js?v=116';
import {
