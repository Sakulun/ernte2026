...
import { getFeld, getUser, netto, showToast, istErnteFuhre, fuhrenArt } from './helpers.js?v=104';
import { getSiloFill, getSiloKultur } from './silo.js?v=104';
import { mengenUebersichtDaten } from './admin-vermehrungen.js?v=104';
import {
