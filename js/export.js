...
import { getFeld, getUser, netto, showToast, istErnteFuhre, fuhrenArt } from './helpers.js?v=109';
import { getSiloFill, getSiloKultur } from './silo.js?v=109';
import { mengenUebersichtDaten } from './admin-vermehrungen.js?v=109';
import {
