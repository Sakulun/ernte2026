...
import { getFeld, getUser, netto, showToast, istErnteFuhre, fuhrenArt } from './helpers.js?v=141';
import { getSiloFill, getSiloKultur } from './silo.js?v=141';
import { mengenUebersichtDaten } from './admin-vermehrungen.js?v=141';
import {
