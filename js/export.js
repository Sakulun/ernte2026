...
import { getFeld, getUser, netto, showToast, istErnteFuhre, fuhrenArt } from './helpers.js?v=137';
import { getSiloFill, getSiloKultur } from './silo.js?v=137';
import { mengenUebersichtDaten } from './admin-vermehrungen.js?v=137';
import {
