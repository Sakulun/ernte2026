...
import { getFeld, getUser, netto, showToast, istErnteFuhre, fuhrenArt } from './helpers.js?v=140';
import { getSiloFill, getSiloKultur } from './silo.js?v=140';
import { mengenUebersichtDaten } from './admin-vermehrungen.js?v=140';
import {
