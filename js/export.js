...
import { getFeld, getUser, netto, showToast, istErnteFuhre, fuhrenArt } from './helpers.js?v=128';
import { getSiloFill, getSiloKultur } from './silo.js?v=128';
import { mengenUebersichtDaten } from './admin-vermehrungen.js?v=128';
import {
