...
import { getFeld, getUser, netto, showToast, istErnteFuhre, fuhrenArt } from './helpers.js?v=114';
import { getSiloFill, getSiloKultur } from './silo.js?v=114';
import { mengenUebersichtDaten } from './admin-vermehrungen.js?v=114';
import {
