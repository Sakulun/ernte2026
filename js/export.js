...
import { getFeld, getUser, netto, showToast, istErnteFuhre, fuhrenArt } from './helpers.js?v=127';
import { getSiloFill, getSiloKultur } from './silo.js?v=127';
import { mengenUebersichtDaten } from './admin-vermehrungen.js?v=127';
import {
