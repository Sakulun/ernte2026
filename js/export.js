...
import { getFeld, getUser, netto, showToast, istErnteFuhre, fuhrenArt } from './helpers.js?v=139';
import { getSiloFill, getSiloKultur } from './silo.js?v=139';
import { mengenUebersichtDaten } from './admin-vermehrungen.js?v=139';
import {
