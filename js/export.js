...
import { getFeld, getUser, netto, showToast, istErnteFuhre, fuhrenArt } from './helpers.js?v=108';
import { getSiloFill, getSiloKultur } from './silo.js?v=108';
import { mengenUebersichtDaten } from './admin-vermehrungen.js?v=108';
import {
