...
import { getFeld, getUser, netto, showToast, istErnteFuhre, fuhrenArt } from './helpers.js?v=133';
import { getSiloFill, getSiloKultur } from './silo.js?v=133';
import { mengenUebersichtDaten } from './admin-vermehrungen.js?v=133';
import {
