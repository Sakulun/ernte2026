...
import { getFeld, getUser, netto, showToast, istErnteFuhre, fuhrenArt } from './helpers.js?v=126';
import { getSiloFill, getSiloKultur } from './silo.js?v=126';
import { mengenUebersichtDaten } from './admin-vermehrungen.js?v=126';
import {
