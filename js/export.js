...
import { getFeld, getUser, netto, showToast, istErnteFuhre, fuhrenArt } from './helpers.js?v=142';
import { getSiloFill, getSiloKultur } from './silo.js?v=142';
import { mengenUebersichtDaten } from './admin-vermehrungen.js?v=142';
import {
