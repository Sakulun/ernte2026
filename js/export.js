...
import { getFeld, getUser, netto, showToast, istErnteFuhre, fuhrenArt } from './helpers.js?v=111';
import { getSiloFill, getSiloKultur } from './silo.js?v=111';
import { mengenUebersichtDaten } from './admin-vermehrungen.js?v=111';
import {
