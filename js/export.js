...
import { getFeld, getUser, netto, showToast, istErnteFuhre, fuhrenArt } from './helpers.js?v=125';
import { getSiloFill, getSiloKultur } from './silo.js?v=125';
import { mengenUebersichtDaten } from './admin-vermehrungen.js?v=125';
import {
