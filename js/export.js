...
import { getFeld, getUser, netto, showToast, istErnteFuhre, fuhrenArt } from './helpers.js?v=117';
import { getSiloFill, getSiloKultur } from './silo.js?v=117';
import { mengenUebersichtDaten } from './admin-vermehrungen.js?v=117';
import {
