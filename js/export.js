...
import { getFeld, getUser, netto, showToast, istErnteFuhre, fuhrenArt } from './helpers.js?v=115';
import { getSiloFill, getSiloKultur } from './silo.js?v=115';
import { mengenUebersichtDaten } from './admin-vermehrungen.js?v=115';
import {
