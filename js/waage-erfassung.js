...
import { getFeld, showToast, escapeHtml, kg2t, kontaktAnschrift } from './helpers.js?v=78';
import { isBioFeld } from './bio.js?v=78';
import { getQualitaetsfelder } from './quality.js?v=78';
import { parseGewicht } from './abfahrer.js?v=78';
import { lieferscheinDrucken } from './lieferschein-druck.js?v=78';
