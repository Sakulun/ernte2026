...
import { getFeld, showToast, escapeHtml, kg2t, kontaktAnschrift } from './helpers.js?v=63';
import { isBioFeld } from './bio.js?v=63';
import { getQualitaetsfelder } from './quality.js?v=63';
import { parseGewicht } from './abfahrer.js?v=63';
import { lieferscheinDrucken } from './lieferschein-druck.js?v=63';
