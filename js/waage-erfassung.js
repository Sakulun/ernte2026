...
import { getFeld, showToast, escapeHtml, kg2t, kontaktAnschrift } from './helpers.js?v=70';
import { isBioFeld } from './bio.js?v=70';
import { getQualitaetsfelder } from './quality.js?v=70';
import { parseGewicht } from './abfahrer.js?v=70';
import { lieferscheinDrucken } from './lieferschein-druck.js?v=70';
