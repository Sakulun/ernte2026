...
import { getFeld, showToast, escapeHtml, kg2t, kontaktAnschrift } from './helpers.js?v=139';
import { isBioFeld } from './bio.js?v=139';
import { getQualitaetsfelder } from './quality.js?v=139';
import { parseGewicht } from './abfahrer.js?v=139';
import { lieferscheinDrucken, lieferscheinArtikelName } from './lieferschein-druck.js?v=139';
