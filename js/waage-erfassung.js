...
import { getFeld, showToast, escapeHtml, kg2t, kontaktAnschrift } from './helpers.js?v=130';
import { isBioFeld } from './bio.js?v=130';
import { getQualitaetsfelder } from './quality.js?v=130';
import { parseGewicht } from './abfahrer.js?v=130';
import { lieferscheinDrucken, lieferscheinArtikelName } from './lieferschein-druck.js?v=130';
