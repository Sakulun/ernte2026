...
import { getFeld, showToast, escapeHtml, kg2t, kontaktAnschrift } from './helpers.js?v=66';
import { isBioFeld } from './bio.js?v=66';
import { getQualitaetsfelder } from './quality.js?v=66';
import { parseGewicht } from './abfahrer.js?v=66';
import { lieferscheinDrucken } from './lieferschein-druck.js?v=66';
