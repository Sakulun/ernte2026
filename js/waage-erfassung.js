...
import { getFeld, showToast, escapeHtml, kg2t, kontaktAnschrift } from './helpers.js?v=119';
import { isBioFeld } from './bio.js?v=119';
import { getQualitaetsfelder } from './quality.js?v=119';
import { parseGewicht } from './abfahrer.js?v=119';
import { lieferscheinDrucken, lieferscheinArtikelName } from './lieferschein-druck.js?v=119';
