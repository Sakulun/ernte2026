...
import { getFeld, showToast, escapeHtml, kg2t, kontaktAnschrift } from './helpers.js?v=71';
import { isBioFeld } from './bio.js?v=71';
import { getQualitaetsfelder } from './quality.js?v=71';
import { parseGewicht } from './abfahrer.js?v=71';
import { lieferscheinDrucken } from './lieferschein-druck.js?v=71';
