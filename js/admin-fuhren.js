...
import { getFeld, getUser, netto, kg2t, fmtDate, fmtTime, showToast, escapeHtml, sorteBadge } from './helpers.js?v=107';
import { getFruchtFarbe } from './frucht.js?v=107';
import { alleLagerOrte, lagerLabel } from './silo.js?v=107';
import { exportFuhrenCSV, exportFuhrenExcel } from './export.js?v=107';
import { isBioFuhre, bioBadge } from './bio.js?v=107';
