...
import { getFeld, getUser, netto, kg2t, fmtDate, fmtTime, showToast, escapeHtml, sorteBadge } from './helpers.js?v=36';
import { getFruchtFarbe } from './frucht.js?v=36';
import { alleLagerOrte, lagerLabel } from './silo.js?v=36';
