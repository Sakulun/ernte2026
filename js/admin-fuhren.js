...
import { getFeld, getUser, netto, kg2t, fmtDate, fmtTime, showToast, escapeHtml, sorteBadge } from './helpers.js?v=99';
import { getFruchtFarbe } from './frucht.js?v=99';
import { alleLagerOrte, lagerLabel } from './silo.js?v=99';
import { exportFuhrenCSV, exportFuhrenExcel } from './export.js?v=99';
import { isBioFuhre, bioBadge } from './bio.js?v=99';
