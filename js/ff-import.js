...
import { getSb } from './db.js?v=122';
import { showToast, escapeHtml } from './helpers.js?v=122';
import { ffState, ffLoadStammdaten, ffRecompute, ffInvalidateJahr, renderFruchtfolge } from './fruchtfolge.js?v=122';
import { parseAgrarantragZip } from './ff-import-parser.js?v=122';
