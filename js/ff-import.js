...
import { getSb } from './db.js?v=126';
import { showToast, escapeHtml } from './helpers.js?v=126';
import { ffState, ffLoadStammdaten, ffRecompute, ffInvalidateJahr, renderFruchtfolge } from './fruchtfolge.js?v=126';
import { parseAgrarantragZip } from './ff-import-parser.js?v=126';
