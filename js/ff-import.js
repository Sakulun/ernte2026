...
import { getSb } from './db.js?v=138';
import { showToast, escapeHtml } from './helpers.js?v=138';
import { ffState, ffLoadStammdaten, ffRecompute, ffInvalidateJahr, renderFruchtfolge } from './fruchtfolge.js?v=138';
import { parseAgrarantragZip } from './ff-import-parser.js?v=138';
