...
import { getSb } from './db.js?v=142';
import { showToast, escapeHtml } from './helpers.js?v=142';
import { ffState, ffLoadStammdaten, ffRecompute, ffInvalidateJahr, renderFruchtfolge } from './fruchtfolge.js?v=142';
import { parseAgrarantragZip } from './ff-import-parser.js?v=142';
