...
import { showToast, escapeHtml, getFeld, getUser, netto } from './helpers.js?v=26';
import { getSiloBestand, getSiloKultur } from './silo.js?v=26';
import { parseGewicht, fmtGewicht } from './abfahrer.js?v=26';
