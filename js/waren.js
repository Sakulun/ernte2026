...
import { showToast, escapeHtml, getFeld, getUser, netto } from './helpers.js?v=42';
import { getSiloBestand, getSiloKultur, lagerLabel } from './silo.js?v=42';
import { parseGewicht, fmtGewicht } from './abfahrer.js?v=42';
