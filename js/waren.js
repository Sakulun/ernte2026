...
import { showToast, escapeHtml, getFeld, getUser, netto, kontaktAnschriftZeile } from './helpers.js?v=91';
import { getSiloBestand, getSiloKultur, lagerLabel } from './silo.js?v=91';
import { parseGewicht, fmtGewicht } from './abfahrer.js?v=91';
