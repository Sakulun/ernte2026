...
import { showToast, escapeHtml, getFeld, getUser, netto } from './helpers.js?v=29';
import { getSiloBestand, getSiloKultur } from './silo.js?v=29';
import { parseGewicht, fmtGewicht } from './abfahrer.js?v=29';
