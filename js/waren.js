...
import { showToast, escapeHtml, getFeld, getUser, netto } from './helpers.js?v=31';
import { getSiloBestand, getSiloKultur } from './silo.js?v=31';
import { parseGewicht, fmtGewicht } from './abfahrer.js?v=31';
