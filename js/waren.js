...
import { showToast, escapeHtml, getFeld, getUser, netto } from './helpers.js?v=27';
import { getSiloBestand, getSiloKultur } from './silo.js?v=27';
import { parseGewicht, fmtGewicht } from './abfahrer.js?v=27';
