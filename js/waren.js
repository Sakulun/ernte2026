...
import { showToast, escapeHtml, getFeld, getUser, netto } from './helpers.js?v=28';
import { getSiloBestand, getSiloKultur } from './silo.js?v=28';
import { parseGewicht, fmtGewicht } from './abfahrer.js?v=28';
