...
import { showToast, escapeHtml, getFeld, getUser, netto } from './helpers.js?v=25';
import { getSiloBestand, getSiloKultur } from './silo.js?v=25';
import { parseGewicht, fmtGewicht } from './abfahrer.js?v=25';
