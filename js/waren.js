...
import { showToast, escapeHtml, getFeld, getUser, netto, kontaktAnschriftZeile } from './helpers.js?v=72';
import { getSiloBestand, getSiloKultur, lagerLabel } from './silo.js?v=72';
import { parseGewicht, fmtGewicht } from './abfahrer.js?v=72';
