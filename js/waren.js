...
import { showToast, escapeHtml, getFeld, getUser, netto } from './helpers.js?v=38';
import { getSiloBestand, getSiloKultur, lagerLabel } from './silo.js?v=38';
import { parseGewicht, fmtGewicht } from './abfahrer.js?v=38';
