...
import { showToast, escapeHtml, getFeld, getUser, netto } from './helpers.js?v=48';
import { getSiloBestand, getSiloKultur, lagerLabel } from './silo.js?v=48';
import { parseGewicht, fmtGewicht } from './abfahrer.js?v=48';
