...
import { showToast, escapeHtml, getFeld, getUser, netto } from './helpers.js?v=30';
import { getSiloBestand, getSiloKultur } from './silo.js?v=30';
import { parseGewicht, fmtGewicht } from './abfahrer.js?v=30';
