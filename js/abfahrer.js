...
import { getFeld, netto, kg2t, fmtTime, showToast, navigiereZuSchlag, sorteBadge } from './helpers.js?v=34';
import { isBioFuhre, bioBadge } from './bio.js?v=34';
import { getFruchtFarbe } from './frucht.js?v=34';
import { getQualitaetsfelder } from './quality.js?v=34';
