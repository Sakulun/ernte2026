...
import { getFeld, netto, kg2t, fmtTime, showToast, navigiereZuSchlag, sorteBadge } from './helpers.js?v=33';
import { isBioFuhre, bioBadge } from './bio.js?v=33';
import { getFruchtFarbe } from './frucht.js?v=33';
import { getQualitaetsfelder } from './quality.js?v=33';
