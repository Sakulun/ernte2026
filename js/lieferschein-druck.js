...
import { escapeHtml, showToast, kontaktAnschrift } from './helpers.js?v=105';
import { renderLieferschein } from './lieferschein.js?v=105';
import { ZERT_NACHHALTIG, ZERT_OEKO, ZERT_GMP_REG, ZERT_GMP_ZERT } from './config.js?v=105';
