...
import { getUser, getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml } from './helpers.js?v=88';
import { getFruchtFarbe } from './frucht.js?v=88';
import { feuchteZuHoch } from './quality.js?v=88';
import { fuhreKm, abladeStelle } from './geo.js?v=88';
import { lagerLabel } from './silo.js?v=88';
