...
import { getUser, getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml } from './helpers.js?v=135';
import { getFruchtFarbe } from './frucht.js?v=135';
import { feuchteZuHoch } from './quality.js?v=135';
import { fuhreKm, abladeStelle } from './geo.js?v=135';
import { lagerLabel } from './silo.js?v=135';
