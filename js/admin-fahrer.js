...
import { getUser, getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml } from './helpers.js?v=121';
import { getFruchtFarbe } from './frucht.js?v=121';
import { feuchteZuHoch } from './quality.js?v=121';
import { fuhreKm, abladeStelle } from './geo.js?v=121';
import { lagerLabel } from './silo.js?v=121';
