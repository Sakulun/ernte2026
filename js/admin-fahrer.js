...
import { getUser, getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml } from './helpers.js?v=60';
import { getFruchtFarbe } from './frucht.js?v=60';
import { feuchteZuHoch } from './quality.js?v=60';
import { fuhreKm, abladeStelle } from './geo.js?v=60';
import { lagerLabel } from './silo.js?v=60';
