...
import { getUser, getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml } from './helpers.js?v=143';
import { getFruchtFarbe } from './frucht.js?v=143';
import { feuchteZuHoch } from './quality.js?v=143';
import { fuhreKm, abladeStelle } from './geo.js?v=143';
import { lagerLabel } from './silo.js?v=143';
