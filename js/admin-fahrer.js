...
import { getUser, getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml } from './helpers.js?v=87';
import { getFruchtFarbe } from './frucht.js?v=87';
import { feuchteZuHoch } from './quality.js?v=87';
import { fuhreKm, abladeStelle } from './geo.js?v=87';
import { lagerLabel } from './silo.js?v=87';
