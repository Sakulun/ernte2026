...
import { getUser, getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml } from './helpers.js?v=118';
import { getFruchtFarbe } from './frucht.js?v=118';
import { feuchteZuHoch } from './quality.js?v=118';
import { fuhreKm, abladeStelle } from './geo.js?v=118';
import { lagerLabel } from './silo.js?v=118';
