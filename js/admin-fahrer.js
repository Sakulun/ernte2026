...
import { getUser, getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml } from './helpers.js?v=128';
import { getFruchtFarbe } from './frucht.js?v=128';
import { feuchteZuHoch } from './quality.js?v=128';
import { fuhreKm, abladeStelle } from './geo.js?v=128';
import { lagerLabel } from './silo.js?v=128';
