...
import { getUser, getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml } from './helpers.js?v=84';
import { getFruchtFarbe } from './frucht.js?v=84';
import { feuchteZuHoch } from './quality.js?v=84';
import { fuhreKm, abladeStelle } from './geo.js?v=84';
import { lagerLabel } from './silo.js?v=84';
