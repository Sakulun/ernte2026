...
import { getUser, getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml } from './helpers.js?v=136';
import { getFruchtFarbe } from './frucht.js?v=136';
import { feuchteZuHoch } from './quality.js?v=136';
import { fuhreKm, abladeStelle } from './geo.js?v=136';
import { lagerLabel } from './silo.js?v=136';
