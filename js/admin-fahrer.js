...
import { getUser, getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml } from './helpers.js?v=122';
import { getFruchtFarbe } from './frucht.js?v=122';
import { feuchteZuHoch } from './quality.js?v=122';
import { fuhreKm, abladeStelle } from './geo.js?v=122';
import { lagerLabel } from './silo.js?v=122';
