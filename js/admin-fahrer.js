...
import { getUser, getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml } from './helpers.js?v=104';
import { getFruchtFarbe } from './frucht.js?v=104';
import { feuchteZuHoch } from './quality.js?v=104';
import { fuhreKm, abladeStelle } from './geo.js?v=104';
import { lagerLabel } from './silo.js?v=104';
