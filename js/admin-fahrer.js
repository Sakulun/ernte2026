...
import { getUser, getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml } from './helpers.js?v=123';
import { getFruchtFarbe } from './frucht.js?v=123';
import { feuchteZuHoch } from './quality.js?v=123';
import { fuhreKm, abladeStelle } from './geo.js?v=123';
import { lagerLabel } from './silo.js?v=123';
