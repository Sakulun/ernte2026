...
import { getUser, getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml } from './helpers.js?v=80';
import { getFruchtFarbe } from './frucht.js?v=80';
import { feuchteZuHoch } from './quality.js?v=80';
import { fuhreKm, abladeStelle } from './geo.js?v=80';
import { lagerLabel } from './silo.js?v=80';
