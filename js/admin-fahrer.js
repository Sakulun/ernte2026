...
import { getUser, getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml } from './helpers.js?v=112';
import { getFruchtFarbe } from './frucht.js?v=112';
import { feuchteZuHoch } from './quality.js?v=112';
import { fuhreKm, abladeStelle } from './geo.js?v=112';
import { lagerLabel } from './silo.js?v=112';
