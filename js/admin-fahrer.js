...
import { getUser, getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml } from './helpers.js?v=138';
import { getFruchtFarbe } from './frucht.js?v=138';
import { feuchteZuHoch } from './quality.js?v=138';
import { fuhreKm, abladeStelle } from './geo.js?v=138';
import { lagerLabel } from './silo.js?v=138';
