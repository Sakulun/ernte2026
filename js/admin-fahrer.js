...
import { getUser, getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml } from './helpers.js?v=61';
import { getFruchtFarbe } from './frucht.js?v=61';
import { feuchteZuHoch } from './quality.js?v=61';
import { fuhreKm, abladeStelle } from './geo.js?v=61';
import { lagerLabel } from './silo.js?v=61';
