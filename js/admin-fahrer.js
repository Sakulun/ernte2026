...
import { getUser, getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml } from './helpers.js?v=137';
import { getFruchtFarbe } from './frucht.js?v=137';
import { feuchteZuHoch } from './quality.js?v=137';
import { fuhreKm, abladeStelle } from './geo.js?v=137';
import { lagerLabel } from './silo.js?v=137';
