...
import { getUser, getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml } from './helpers.js?v=62';
import { getFruchtFarbe } from './frucht.js?v=62';
import { feuchteZuHoch } from './quality.js?v=62';
import { fuhreKm, abladeStelle } from './geo.js?v=62';
import { lagerLabel } from './silo.js?v=62';
