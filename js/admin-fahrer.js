...
import { getUser, getFeld, netto, kg2t, fmtDate, fmtTime, escapeHtml } from './helpers.js?v=59';
import { getFruchtFarbe } from './frucht.js?v=59';
import { feuchteZuHoch } from './quality.js?v=59';
import { fuhreKm, abladeStelle } from './geo.js?v=59';
import { lagerLabel } from './silo.js?v=59';
